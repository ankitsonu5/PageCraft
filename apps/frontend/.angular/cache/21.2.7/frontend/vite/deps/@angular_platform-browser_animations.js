import { BrowserModule, DomRendererFactory2 } from "./chunk-G7VINI3R.js";
import "./chunk-DBCMNT3W.js";
...
var WebAnimationsPlayer = class {
  ...
  _buildPlayer() {
    ...
    const animation = this._triggerWebAnimation(
      this.element,
      keyframes,
      this.options,
    );
...
var BROWSER_ANIMATIONS_PROVIDERS = [
  {
    provide: AnimationDriver,
    useFactory: () =>
      false ? new NoopAnimationDriver() : new WebAnimationsDriver(),
  },
  {
    provide: ANIMATION_MODULE_TYPE,
