import { isPlatformBrowser } from "./chunk-DBCMNT3W.js";
import "./chunk-7VWQJIIP.js";
import {
  APP_ID,
  ApplicationRef,
...
var FixedSizeVirtualScrollStrategy = class {
  ...
  _updateRenderedRange() {
    ...
    this._viewport.setRenderedContentOffset(
      Math.round(this._itemSize * newRange.start),
    );
...
var SCROLL_SCHEDULER =
  typeof requestAnimationFrame !== "undefined"
    ? animationFrameScheduler
    : asapScheduler;
var CDK_VIRTUAL_SCROLL_VIEWPORT = new InjectionToken(
...
var CdkVirtualScrollViewport = class _CdkVirtualScrollViewport extends CdkVirtualScrollable {
  ...
  renderedContentOffset = this._renderedContentOffsetSubject.pipe(
  ...
  _doChangeDetection() {
    ...
    this.ngZone.run(() => {
      ...
      this._renderedContentOffsetSubject.next(
        this.getOffsetToRenderedContentStart(),
      );
      afterNextRender(
        () => {
...
function isOverflowingParent(parentRect, childRect) {
  ...
  const isRightOverflowing =
    childRect.left + childRect.width > parentRect.right;
  const isTopOverflowing = childRect.top < parentRect.top;
  const isBottomOverflowing =
    childRect.top + childRect.height > parentRect.bottom;
  return (
    isLeftOverflowing ||
    isRightOverflowing ||
    isTopOverflowing ||
...
var DragRef = class {
  ...
  _updateActiveDropContainer({ x, y }, { x: rawX, y: rawY }) {
    ...
    if (newContainer && newContainer !== this._dropContainer) {
      this._ngZone.run(() => {
        ...
        this._conditionallyInsertAnchor(
          newContainer,
          this._dropContainer,
          nextItemElement,
        );
  ...
  _conditionallyInsertAnchor(newContainer, exitContainer, nextItemElement) {
    if (newContainer === this._initialContainer) {
      ...
      exitContainer === this._initialContainer &&
      exitContainer.hasAnchor
    ) {
...
var SingleAxisSortStrategy = class {
  ...
  getItemIndex(item) {
    return this._getVisualItemPositions().findIndex(
      (currentItem) => currentItem.drag === item,
    );
  }
